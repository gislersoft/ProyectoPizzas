...
!function (n, i) {
    if ("function" == typeof define && define.amd) define(["jquery"], i); else if ("undefined" != typeof exports) i(require("jquery")); else {
        var t = {exports: {}};
        i(n.jquery), n.metisMenu = t.exports
    }
}(this, function (n) {
    "use strict";
    ...
    var t = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (n) {
        ...
        function i() {
            return {
                bindType: s.end, delegateType: s.end, handle: function (i) {
        ...
        function t() {
            ...
            for (var i in o) if (void 0 !== n.style[i]) return {end: o[i]};
            return !1
        }
        ...
        function e(i) {
            ...
            return n(this).one(a.TRANSITION_END, function () {
                ...
                e || a.triggerTransitionEnd(t)
            }, i), this
        }

        var s = !1, o = {WebkitTransition: "webkitTransitionEnd", MozTransition: "transitionend", OTransition: "oTransitionEnd otransitionend", transition: "transitionend"}, a = {
        ...
        return s = t(), n.fn.emulateTransitionEnd = e, a.supportsTransitionEnd() && (n.event.special[a.TRANSITION_END] = i()), a
    }(jQuery);
    !function (n) {
        var s = "metisMenu", o = n.fn[s], a = {toggle: !0, preventDefault: !0, activeClass: "active", collapseClass: "collapse", collapseInClass: "in", collapsingClass: "collapsing", triggerElement: "a", parentTrigger: "li", subMenu: "ul"}, r = {SHOW: "show.metisMenu", SHOWN: "shown.metisMenu", HIDE: "hide.metisMenu", HIDDEN: "hidden.metisMenu", CLICK_DATA_API: "click.metisMenu.data-api"}, l = function () {
            function s(n, t) {
                i(this, s), this._element = n, this._config = this._getConfig(t), this._transitioning = null, this.init()
            }

            return s.prototype.init = function () {
                var i = this;
                n(this._element).find(this._config.parentTrigger + "." + this._config.activeClass).has(this._config.subMenu).children(this._config.subMenu).attr("aria-expanded", !0).addClass(this._config.collapseClass + " " + this._config.collapseInClass), n(this._element).find(this._config.parentTrigger).not("." + this._config.activeClass).has(this._config.subMenu).children(this._config.subMenu).attr("aria-expanded", !1).addClass(this._config.collapseClass), n(this._element).find(this._config.parentTrigger).has(this._config.subMenu).children(this._config.triggerElement).on(r.CLICK_DATA_API, function (t) {
                    var e = n(this), s = e.parent(i._config.parentTrigger), o = s.siblings(i._config.parentTrigger).children(i._config.triggerElement), a = s.children(i._config.subMenu);
                ...
                if (!this._transitioning && !n(i).hasClass(this._config.collapsingClass)) {
                    ...
                    if (s.trigger(o), !o.isDefaultPrevented()) {
                        ...
                        var a = function () {
                            t._config && t._element && (s.removeClass(t._config.collapsingClass).addClass(t._config.collapseClass + " " + t._config.collapseInClass).height("").attr("aria-expanded", !0), t.setTransitioning(!1), s.trigger(r.SHOWN))
                        };
                        e.supportsTransitionEnd() ? s.height(s[0].scrollHeight).one(e.TRANSITION_END, a).emulateTransitionEnd(350) : a()
                    }
                }
            }, s.prototype._hide = function (i) {
                if (!this._transitioning && n(i).hasClass(this._config.collapseInClass)) {
                    var t = this, s = n(i), o = n.Event(r.HIDE);
                    if (s.trigger(o), !o.isDefaultPrevented()) {
                        ...
                        var a = function () {
                            t._config && t._element && (t._transitioning && t._config.onTransitionEnd && t._config.onTransitionEnd(), t.setTransitioning(!1), s.trigger(r.HIDDEN), s.removeClass(t._config.collapsingClass).addClass(t._config.collapseClass).attr("aria-expanded", !1))
                        };
                        e.supportsTransitionEnd() ? 0 == s.height() || "none" == s.css("display") ? a() : s.height(0).one(e.TRANSITION_END, a).emulateTransitionEnd(350) : a()
                    }
                }
            }, s.prototype.setTransitioning = function (n) {
                this._transitioning = n
            }, s.prototype.dispose = function () {
                n.removeData(this._element, "metisMenu"), n(this._element).find(this._config.parentTrigger).has(this._config.subMenu).children(this._config.triggerElement).off("click"), this._transitioning = null, this._config = null, this._element = null
            }, s.prototype._getConfig = function (i) {
                return i = n.extend({}, a, i)
            }, s._jQueryInterface = function (i) {
                return this.each(function () {
                    var e = n(this), o = e.data("metisMenu"), r = n.extend({}, a, e.data(), "object" === (void 0 === i ? "undefined" : t(i)) && i);
                    if (!o && /dispose/.test(i) && this.dispose(), o || (o = new s(this, r), e.data("metisMenu", o)), "string" == typeof i) {
        ...
        n.fn[s] = l._jQueryInterface, n.fn[s].Constructor = l, n.fn[s].noConflict = function () {
            return n.fn[s] = o, l._jQueryInterface
        }
    }(jQuery)
});
